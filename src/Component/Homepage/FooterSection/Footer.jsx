  ...
  return (
    <>
            ...
            <div className="footer-container">
                ...
                <h3 style={{color:'#777'}}> <img src={logoo2} alt='logo' className='logo-footer' />EFM HUP</h3>
                   <br/>
                    <p>EFM is the strongest company for making money online, offering unparalleled features and strong rewards that make it the best choice for everyone.</p>
                    <br />
    ...
    <div className="footer-contact">
        <span><img src={Telegram} alt="Telegram Icon"   className="icon" />@EFM_Hub</span>
        <span><img src={email} alt="Email Icon"  className="icon" />support@efmhub.com</span>
        <span><img src={phone} alt="Phone Icon"  className="icon"  />+201026055342</span>
    </div>
</div>
