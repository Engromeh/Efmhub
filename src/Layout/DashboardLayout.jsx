        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white mt-2">
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-[#DFBC8A] bg-[#DFBC8A] group"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">UpgradeAccount</span>
                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-[#DFBC8A] rounded-full dark:bg-gray-700 dark:text-gray-300">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">NewOrder</span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">AddFunds</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Current</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">personelsetting</span>
              </a>
            </li>
            <li>
              <a
